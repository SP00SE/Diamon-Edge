...
const TwpTracker = (() => {
  ...
  return { SCHEMA_VERSION, emptyLog, normalizeLog, makeSnapshot, addSnapshot, attachSim, gradeGame, windowDates, computeStats, classifyMiss, setMissCategory, missPatterns };
})();
